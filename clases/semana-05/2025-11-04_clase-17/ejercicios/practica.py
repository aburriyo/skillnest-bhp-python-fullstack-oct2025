...
# |-  retorna usuario_1 -----------------------------------------| 3ra linea
# |-  retorna usuario_1 ----------------------| 2da linea
# |-  retorna usuario_1-----| 1ra linea
# usuario_1.hacer_compra(2000).hacer_compra(3000).pagar_tarjeta(1000)


usuario_1 = usuario_1.hacer_compra(2000) # 1ra linea # Usuario.hacer_compra(self=usuario_1, monto=2000)
usuario_1 = usuario_1.hacer_compra(3000) # 2da linea
usuario_1 = usuario_1.pagar_tarjeta(1000) # 3ra
